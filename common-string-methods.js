...
// 1. Searching
let hasJavaScript = inputString.includes("JavaScript", [0]);
let codingPosition = inputString.indexOf("Coding", [0]);
let startsWithWelcome = inputString.startsWith("Welcome", [0]);
